  ...
  return (
    <div className="flex min-h-screen flex-col items-center bg-white px-6 py-16">
      ...
      <div className="mt-10 flex w-full max-w-2xl flex-col gap-6 rounded-lg border border-slate-200 bg-white p-6 text-sm leading-relaxed text-slate-600">
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-slate-900">1. No accounts</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-slate-900">2. What is collected</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-slate-900">3. Analytics</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-slate-900">4. Third parties</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-slate-900">5. Data retention</h2>
          <p>
