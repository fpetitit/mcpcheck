  ...
  return (
    <div className="flex min-h-screen flex-col items-center bg-black px-6 py-16">
      ...
      <div className="mt-10 flex w-full max-w-2xl flex-col gap-6 rounded-lg border border-[#27272a] bg-black p-6 text-sm leading-relaxed text-white/70">
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-white">1. No accounts</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-white">2. What is collected</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-white">3. Analytics</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-white">4. Third parties</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-white">5. Data retention</h2>
          <p>
        ...
        <section>
          ...
          <p>
            ...
            <span className="text-white">francois.petitit@gmail.com</span>. See also the{" "}
